    ...
    return (
        <>
          <div style={{width:"150px",height:"100vh",backgroundColor:"#4040a1",borderRadius:"0 50px 50px 0"}}> &nbsp;
            <center>
            <img src='https://png.pngtree.com/png-vector/20220906/ourmid/pngtree-graduating-student-icon-design-outline-color-style-vector-laptop-people-vector-png-image_39093260.png' style={{width:"60px",height:"60px",padding:"12px",border:"1px solid black",borderRadius:"50%",backgroundColor:"#fff"}} alt='logo' />
             </center>
             <br/>  
                <nav>
